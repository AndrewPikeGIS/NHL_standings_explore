...
```{r, echo = FALSE, warning = FALSE, message = FALSE}
discrepancies_df_20 <- find_playoff_changes(
    standings_20_21
)
...
```{r, echo = FALSE, warning = FALSE, message = FALSE}
discrepancies_df_19 <- find_playoff_changes_19_20(
    standings_19_20
)
...
```{r, echo = FALSE, warning = FALSE, message = FALSE}
discrepancies_df_14 <- find_playoff_changes(
    wild_card_14_19
)
...
```{r, echo = FALSE, warning = FALSE, message = FALSE}
discrepancies_df_05 <- find_playoff_changes(
    standings_05_13
)
...
# All the Teams/Playoff spots that would Change 

This is a full table of all the changes to playoff seeding that would occur if the point schemas were different.


```{r all_discrepancy_tables, echo = FALSE, warning = FALSE, message = FALSE}
